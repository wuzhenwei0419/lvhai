...
class MarketLogic extends RelationModel
{
    /**
     ...
     */
    public function getMarketList($condition,$start=0,$page_size=20){
        $res = M('hq')->where($condition)->limit("$start,$page_size")->select();
        return $res;
    }
    /*
     * 获取订单商品详情
