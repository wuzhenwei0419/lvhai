 ...
 * @param $filename 文件名
 */
function downloadExcelByDate($strTable,$filename,$date)
{
    header("Content-type: application/vnd.ms-excel");
    header("Content-Type: application/force-download");
...
function getAllMenu(){
	return	array(
			...
			'agent' => array('name' => '入驻管理', 'icon'=>'fa-users', 'sub_menu' => array(
				    array('name' => '代理商列表', 'act'=>'index', 'control'=>'Agent'),
				    array('name' => '申请代理商列表', 'act'=>'applicationlist', 'control'=>'Agent'),
				    array('name' => '供应商管理', 'act'=>'supplier', 'control'=>'Agent'),
				    array('name' => '申请供应商列表', 'act'=>'supplier_lists', 'control'=>'Agent'),
			)),
			...
			'order' => array('name' => '订单管理', 'icon'=>'fa-money', 'sub_menu' => array(
					...
					array('name' => '用户订单列表', 'act'=>'userindex', 'control'=>'Order'),
			...
			'promotion' => array('name' => '营销管理', 'icon'=>'fa-bell', 'sub_menu' => array(
				    array('name' => '代理商拼团管理', 'act'=>'application_buy_list', 'control'=>'Promotion'),
					array('name' => '抢购管理', 'act'=>'flash_sale', 'control'=>'Promotion'),
					array('name' => '拼单管理', 'act'=>'group_buy_list', 'control'=>'Promotion'),
			...
			'market' => array('name' => '水果行情', 'icon'=>'fa-star', 'sub_menu' => array(
					array('name' => '行情列表', 'act'=>'index', 'control'=>'Market'),
			)),
