...
class UsersLogic extends RelationModel
{
    ...
    * 获取总订单商品
    */
    public function get_total_order_goods($order_id){
        $sql = "SELECT og.*,g.original_img FROM __PREFIX__order_goods og LEFT JOIN __PREFIX__goods g ON g.goods_id = og.goods_id WHERE total_order_id = ".$order_id;
        $goods_list = $this->query($sql);
