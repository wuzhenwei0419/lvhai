...
<div id="warpper" class="clearfix">
 ...
 $goodsattr=D()->query("select attr_name ,attr_value from tp_goods_attr as a,tp_goods_attribute as b where a.goods_id=$v[goods_id] and a.attr_id=b.attr_id and attr_name='含糖量'"); echo $goodsattr[0]['attr_name']; echo "："; echo $goodsattr[0]['attr_value']; ?></span>
          ...
          <p class="itemprice">
            <span class="new" rehot="90101748934_201480" style="display: block; float: left;"><i class="fn-rmb">¥</i><?php echo ($v[market_price]); ?></span>              <a href="<?php echo U('Home/user/login');?>" class="Obtain">登录获取最新价格</a>
  ...
  <ul id="cata_choose_product" class="cart_containt clearfix listContainer">
    <?php if(is_array($goods_list)): foreach($goods_list as $k=>$v): ?><li>
        <div class="listbox clearfix"> 
          ...
          <span><?php
 $goodsattr=D()->query("select attr_name ,attr_value from tp_goods_attr as a,tp_goods_attribute as b where a.goods_id=$v[goods_id] and a.attr_id=b.attr_id and attr_name='含糖量'"); echo $goodsattr[0]['attr_name']; echo "："; echo $goodsattr[0]['attr_value']; ?></span></div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
