...
<div class="foot">
    ...
    <dl class="foot-item foot-phone">
	    ...
	    <?php
 $md5_key = md5("select * from `__PREFIX__article_cat` where cat_id in(1,2,3,4,7)"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from `__PREFIX__article_cat` where cat_id in(1,2,3,4,7)"); S("sql_".$md5_key,$sql_result_v,31104000); } foreach($sql_result_v as $k=>$v): ?><dl class="foot-item foot-list">
              <dt class=""><?php echo ($v[cat_name]); ?></dt>
              <?php
 $md5_key = md5("select * from `__PREFIX__article` where cat_id = $v[cat_id]"); $result_name = $sql_result_v2 = S("sql_".$md5_key); if(empty($sql_result_v2)) { $Model = new \Think\Model(); $result_name = $sql_result_v2 = $Model->query("select * from `__PREFIX__article` where cat_id = $v[cat_id]"); S("sql_".$md5_key,$sql_result_v2,31104000); } foreach($sql_result_v2 as $k2=>$v2): ?><dd><a target="_blank" href="<?php echo U('Home/Article/detail',array('article_id'=>$v2[article_id]));?>"><?php echo ($v2[title]); ?></a></dd><?php endforeach; ?>
	        </dl><?php endforeach; ?>  
  ...
  <div class="foot-info container">
    ...
    <ul class="foot-chop">
              ...
              <li> <a href="" target="_blank"> <img width="auto" height="auto" src="/Template/pc/soubao/Static/images/time_cnnic.jpg"> </a> </li>
              <li> <a href="" target="_blank"> <img width="auto" height="auto"src="/Template/pc/soubao/Static/images/aqlm.jpg"> </a> </li>
            </ul>
  </div>
</div>
<div class="kf">
  ...
  <div class="kf-content">
    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=3135142870&amp;Site=中果国际&amp;Menu=yes"><img width="auto" height="auto" src="/Template/pc/soubao/Static/images/lvhai/2.gif"><span>客服橙子</span></a>
    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=3135142870&amp;Site=中果国际&amp;Menu=yes"><img width="auto" height="auto" src="/Template/pc/soubao/Static/images/lvhai/2.gif"><span>客服香梨</span></a>
    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=3135142870&amp;Site=中果国际&amp;Menu=yes"><img  width="auto" height="auto"src="/Template/pc/soubao/Static/images/lvhai/2.gif"><span>客服提子</span></a>
    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=3135142870&amp;Site=中果国际&amp;Menu=yes"><img width="auto" height="auto" src="/Template/pc/soubao/Static/images/lvhai/2.gif"><span>客服榴莲</span></a>
    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=3135142870&amp;Site=中果国际&amp;Menu=yes"><img width="auto" height="auto" src="/Template/pc/soubao/Static/images/lvhai/2.gif"><span>客服山竹</span></a>
  </div>
</div>
