...
<?php if(isset($message)) {?>
   <!-- 处理成功 -->
   <div class="box-ts">
    	<i><img width="auto" height="auto" src="/Template/pc/soubao/Static/images/success_ts.png"></i>
        <ul>
...
<?php }else{?>        
     <!-- 处理失败 -->
     <div class="box-ts">
    	<i><img width="auto" height="auto" src="/Template/pc/soubao/Static/images/error_ts.png"></i>
        <ul>
