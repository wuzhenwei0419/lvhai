...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/Template/pc/soubao/Static/css/market.css">
...
<script type="text/javascript">
  ...
  <div id="pageContent" class="pageContent clearfix">
    <div class="hc-warp clearfix" id="page">  
      <div class="hq-left">
        <div class="market">
          <ul>
            <?php if(is_array($article)): foreach($article as $key=>$vo): ?><li class="clearfix">
                <a href="<?php echo U('Home/Markets/details',array('id'=>$vo['article_id']));?>" class="l-left"><img src="<?php echo (hqarticle_thum_images($vo["article_id"],260,130)); ?>" width="auto" height="auto"></a>
                <div class="l-right">
                  <h5><a href="<?php echo U('Home/Markets/details',array('id'=>$vo['article_id']));?>"><?php echo ($vo[title]); ?></a></h5>
                  <p><?php echo ($vo[content]); ?></p>
                  <span class="date"><i class="demo-icon">&#xe805;</i><?php echo (date("Y-m-d",$vo["publish_time"])); ?> </span>
                </div>
              </li><?php endforeach; endif; ?>
          </ul>
        </div>
 <!-- Page -->
      ...
      <div class="hq-right">
        <img width="auto" height="auto"src="/Template/pc/soubao/Static/images/lvhai/hq-r.png" alt="">
        <div class="bottom">
          <ul>
            <?php if(is_array($articlelist)): foreach($articlelist as $key=>$vo): ?><li>
              <a href="<?php echo U('Home/Markets/details',array('id'=>$vo['article_id']));?>"><?php echo ($vo[title]); ?></a>
            </li><?php endforeach; endif; ?>
          </ul>
        </div>
      </div>
