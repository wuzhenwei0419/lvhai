...
<div class="ng-form-zhu" style="text-align: center;font-size:16px;">
    <div class="tips_a">
        ...
        <img width="auto" height="auto" src="/Template/mobile/new/Static/images/xin/icogantanhao.png"></div>
    <?php }else{ ?>
    <img  width="auto" height="auto"src="/Template/mobile/new/Static/images/xin/icogantanhao-sb.png"></div>
<?php }?>
<div class="tips">
