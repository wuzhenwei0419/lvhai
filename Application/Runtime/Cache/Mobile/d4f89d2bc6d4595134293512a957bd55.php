...
<ul class="product_list" id="good_list">
    <?php if(is_array($goodsList)): foreach($goodsList as $k=>$v): ?><li>
            <a class="url" href="<?php echo U('Goods/goodsInfo',array('id'=>$v[goods_id]));?>">
                <img width="auto" height="auto" src="<?php echo (goods_thum_images($v["goods_id"],200,200)); ?>">   </a>
            <a href="<?php echo U('Goods/goodsInfo',array('id'=>$v[goods_id]));?>"  class="info_wrap">
                <div class="fn good"><?php echo ($v["goods_name"]); ?></div>
                <div class="price_wrap">
                    <i class="discount"  style="display:;"><?php echo round($v[price] / $v[shop_price] * 10 , 1); ?>折</i> <span class="price" style="display:;"></span> <del class="old_price"  style="display:;"><?php echo ($v["shop_price"]); ?></del>
                </div>
                <div class="bottom_info">
                    <span class="remain_num" style="display:;"><strong>已有</strong><?php echo ($v[click_count]); ?>人浏览</span>
