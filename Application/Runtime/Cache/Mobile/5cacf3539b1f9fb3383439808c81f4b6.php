...
<section class="_pre" >
 ...
 $goodsattr=D()->query("select attr_name ,attr_value from tp_goods_attr as a,tp_goods_attribute as b where a.goods_id=$vo[goods_id] and a.attr_id=b.attr_id and attr_name='含糖量'"); echo $goodsattr[0]['attr_name']; echo "："; echo $goodsattr[0]['attr_value']; ?></span>
							</div>
...
<a href="javascript:goTop();" class="gotop" style=" z-index:9999"><img width="auto" height="auto" src="/Template/mobile/new/Static/images/topup.png"></a>
</body>
</html>