...
<div class="com_top">
	...
	<dl>
		<dt>
			<img width="auto" height="auto"src='<?php echo ((isset($user[head_pic]) && ($user[head_pic] !== ""))?($user[head_pic]):"/Template/mobile/new/Static/images/user68.jpg"); ?>' />
		</dt>
	</dl>
</div>
...
<div class="Wallet">
	...
	<a href="<?php echo U('Mobile/User/withdrawals');?>" style="border-bottom: 1px solid #eeeeee"><em class="Icon Icon1"></em><dl><dt>申请提现</dt><dd>&nbsp;</dd></dl></a>
	<a href="<?php echo U('Mobile/User/pass');?>" ><em class="Icon Icon9"></em><dl><dt>代理商</dt><dd>&nbsp;</dd></dl></a>
	<a href="<?php echo U('Mobile/User/supplier');?>" style="border-bottom: 1px solid #eeeeee"><em class="Icon Icon6"></em><dl><dt>供应商</dt><dd>&nbsp;</dd></dl></a>
</div>
<div class="Wallet">
