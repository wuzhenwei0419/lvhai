    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="javascript:sort('is_hot');">拼单</a>
                </td>                   
                <td class="text-center">
            ...
            <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="text-center">
                        <img width="20" height="20" src="/Public/images/<?php if($list[is_collage] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods','goods_id','<?php echo ($list["goods_id"]); ?>','is_collage',this)"/>
                    </td>                                         
                    <td class="text-center">                         
