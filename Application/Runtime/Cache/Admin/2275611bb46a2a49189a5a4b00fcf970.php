    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
          ...
          <div class="form-group has-feedback">
          	<opinioncontrol realtime="true" opinion_name="vertify_code" default="true">
                <div class="row" style="padding-right: 65px;">
                    ...
                    <div class="col-xs-4">
                        <img height="auto" width="auto" id="imgVerify" style="cursor:pointer;" src="<?php echo U('Admin/vertify');?>" onclick="fleshVerify();"/>
                    </div>
                </div>
            </opinioncontrol>
          </div>
	    ...
	    <div class="margin text-center">
	        <div class="copyright">
	            2018-2020 © LVHAILIFE.COM <a href="http://www.lvhai.shop/">v1.0.1</a>
	            <br/>
	            <a href="http://www.lvhai.shop/">江苏绿海果业有限公司</a>
	        </div>
	    </div>
    </div><!-- /.login-box -->
    <!-- jQuery 2.1.4 -->
