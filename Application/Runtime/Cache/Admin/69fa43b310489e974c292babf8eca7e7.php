                    ...
                    <div class="box  box-success">
				        <div class="box-body">
				        	<div class="info-box">
					         	<table class="table table-bordered">
					         		<tr>
					         			<td>程序版本：</td><td>ADMIN <?php echo ($sys_info["version"]); ?></td>
					         			<td>更新时间：</td><td>2018-05-01</td>
					         			<td>程序开发：</td><td>江苏绿海果业有限公司</td>			         			
					         		</tr>
					         		<tr>
					         			<td>版权所有：</td><td>江苏绿海果业有限公司</td>
					         			<td>官方站点：</td><td><a href="http://www.lvhailife.com" target="_blank">商业授权</a></td>
					         			<td>官方微信：</td><td><a>绿海生活</a></td>
					         		</tr>
					         	</table>
				         	</div>
				        </div>
