...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      @media (max-width: 767px) { #riframe{ margin-left: 0 !important;} }
    </style>
  </head>
...
<aside class="main-sidebar" style="overflow-y:auto;">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu"> 
          ...
          <li class="treeview"><a href='/Application/Admin/View/Help/index.html' target='_blank'><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>帮助中心</a></li>
        </ul>
      </section>
</aside>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   <div class="pull-right hidden-xs">
	    	感谢使用lvhaiLife.com后台管理系统<b></b>
	   </div>
	   <strong>2018-2020 © LVHAILIFE.COM<a href="http://www.lvhai.shop">江苏绿海果业有限公司</a>.</strong>保留所有权利。
	</footer>
