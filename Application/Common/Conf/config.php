...
//     'REQUIRE_AUTH_ACTION'       => '',        // 默认需要认证操作
    ...
    // 订单用户端显示状态
    //TODO
    'WAITAUDITING'=>' AND order_status = 0 AND pay_code !="cod" ', //订单查询状态 待审核
    'AUDITED'=>' AND order_status = 1 AND shipping_status = 0 AND pay_code !="cod" ', //订单查询状态 已审核
