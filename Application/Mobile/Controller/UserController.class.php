...
class UserController extends MobileBaseController
{
   ...
   public function pass(){
    ...
    //$password = decrypt($p);
    if($phone_num==''){
          $this->success('请先绑定手机',U('Mobile/User/userinfo'));
          // $return_arr = array(
          //                'status' => 1,
          //               'msg'   => '请先绑定手机',                          
...
//     var_dump(print_r($data));
    ...
    public function add_supplier(){
        ...
        $list=$model->add($data);
        if($list){
             $this->success('上传成功',U('Mobile/User/supplier'));
        
        }else{
             $this->error('上传失败',U('Mobile/User/supplier'));   
                }
    ...
    $this->assign('操作成功',U('Mobile/User/supplier'));
   }
